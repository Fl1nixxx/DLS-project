...
def main():
    ...
    with st.sidebar:
        ...
        manual_pixel_area = st.number_input("Площадь пикселя (мм² / px):",min_value=0.1,value=1.0, step=0.1 ,help="Укажите, какую площадь земной поверхности покрывает один пиксель в квадратных метрах.")
